...
public class clase2Array {
     ...
     * for each en javaScript -> nomArreglo.forEach(element)(siendo element cada
     * objeto de arreglo)
     * for each en Java -> for(String nomArreglo: element){}
     * while en JavaScript -> while(condicion){}(verificar que en algun momento se
     * cumpla la condición)
     ...
     * el do while se ocupa en casos donde si o si al menos una vez, se debe
     * realizar la operación
     */
    public static void main(String[] args) {

        System.out.println("*****Bienvenido/a*****");
        // int repeticiones = Integer.parseInt(console.readLine("Ingrese cuantas
        // comisiones va a calcular: "));
        // ********Opcion con contador******** */
        /*
         * int contador = 0;
         * while(contador!=repeticiones){
         * int venta =
         * Integer.parseInt(console.readLine("Ingrese su cifra de ventas: "));
         * if (venta > 10000) {
